GraceAC API & Companion License

    Personal Use: You may use this API and Companion plugin on your own server freely.

    Modifications: You are NOT permitted to distribute modified versions of this software without express written permission from the author (MH-Al0).
